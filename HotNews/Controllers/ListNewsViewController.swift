...
class ListNewsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        newsMaker.getNews(from: .unitedStates, with: .technology) { news in
...
extension ListNewsViewController {
    ...
    private func getImage(from urlString: String, by indexPath: IndexPath, inObject: UICollectionView) -> UIImage {
        ...
        if let image = cachedDataSourse.object(forKey: indexPath.item as AnyObject) { picture = image }
            ...
            self.cachedDataSourse.setObject(picture, forKey: indexPath.item as AnyObject)
        }
...
extension ListNewsViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        controller.picture = cachedDataSourse.object(forKey: indexPath.item as AnyObject)
